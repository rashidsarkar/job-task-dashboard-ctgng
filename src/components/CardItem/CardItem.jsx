...
function CardItem({ text, assing, video, value }) {
  return (
    <div className="relative flex rounded-lg shadow-lg hover:bg-gradient-to-r from-purple-400 to-blue-500 hover:text-white">
      <div className="p-4 py-8 w-9/10">
        ...
        <button className="w-full py-2 font-semibold text-white rounded-lg bg-gradient-to-r from-purple-400 to-blue-500 group-hover:bg-white group-hover:text-blue-500">
          Continue Course
        </button>
      </div>
